...
const TimeSheetDetailsScreen = ({navigation}) => {
  const onboarding_data = {
    candidate_name: 'Jackie Reynolds',
    color: '#1CAF9A',
    company_name: 'Grimes, Breitenberg and Yost',
    contact_name: 'Doug Ebert Jr.',
    due_date: '25-06-2020',
    job_title: 'Principal Marketing Assistant',
    owner_name: 'Mandy Littel',
    status: 'Close',
    update_date: '23-03-2029',
    updateed_by_name: "Ricardo O'Connell",
  };
  ...
  return (
    <SafeAreaView style={commonStyles.SafeAreaView}>
      ...
      <View style={commonStyles.container}>
        ...
        />
        <TimesheetCard item={onboarding_data} />
