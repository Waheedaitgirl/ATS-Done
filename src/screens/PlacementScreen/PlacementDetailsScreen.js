...
const PlacementDetailsScreen = ({navigation}) => {
  const placement_data = {
    candidate_name: 'Rita Prohaska',
    color: '#4a741d',
    company_name: 'Aufderhar - Zieme',
    contact_name: 'Ms. Carrie Monahan',
    expense_report_manager: 'Owen Boyle Sr.',
    job_title: 'Global Quality Architect',
    join_date: '22-12-2019',
    owner_name: 'Wilfred Corkery',
    placed_by: 'Alton Dare',
    release_date: '02-04-2019',
    status: 'Completed',
    time_report_manager: 'Lora Ratke',
    update_date: '26-02-2026',
    updateed_by_name: 'Phyllis Connelly',
  };
  ...
  const [selected_tab, setSelectTab] = useState({
    id: 1,
    tab_name: 'Activities',
    selected: true,
  });
      ...
      <TouchableOpacity
        ...
        <Text
          style={{
            ...
            ...styles.tabText,
            color: selected_tab.id == item.id ? colors.white : '#000',
          }}>
          {item.tab_name}
        </Text>
      </TouchableOpacity>
  ...
  const details = [
    {key: 'Company Job Id', name: 'J-OOJPCC'},
    {key: 'J-OOJPCC', name: '#33139'},
    {key: 'Job Type', name: 'Contract'},
    {key: 'Pay Type', name: 'Hourly'},
    {key: 'Pay/Salary', name: '$ 2000'},
    {key: 'Bill Rate', name: '$ 84'},
    {key: 'Job Priority', name: 'High'},
    {key: 'Duration', name: '2 Years'},
    {key: 'Assigned Recruiter', name: 'ajavaid'},
    {key: 'Job Owner', name: 'Job Owner'},
    {key: 'EEO Category', name: 'Professionals'},
    {key: 'Industry', name: 'IT'},
    {key: 'Education', name: 'Masters'},
    {key: 'Travel Preference', name: 'Once a Week'},
  ];
  return (
    <SafeAreaView style={commonStyles.SafeAreaView}>
      ...
      <View style={commonStyles.container}>
        ...
        />
        <PlacementCard item={placement_data} />
        ...
        {selected_tab.id === 2 && <ScrollView></ScrollView>}
        ...
        <View style={styles.Row}>
          <TouchableOpacity>
            <Feather name={'edit'} color={'#fff'} size={scale(22)} />
          </TouchableOpacity>

          <TouchableOpacity>
            <Entypo size={scale(20)} name={'attachment'} color={'#fff'} />
          </TouchableOpacity>

          <TouchableOpacity>
            <Feather name={'share-2'} color={'#fff'} size={scale(22)} />
          </TouchableOpacity>

          <TouchableOpacity>
            <FontAwesome name={'list-ul'} color={'#fff'} size={scale(22)} />
          </TouchableOpacity>

          <TouchableOpacity>
            <FontAwesome name={'users'} color={'#fff'} size={scale(20)} />
          </TouchableOpacity>

          <TouchableOpacity>
            <Ionicons name={'ios-copy'} color={'#fff'} size={scale(22)} />
          </TouchableOpacity>

          <TouchableOpacity>
            <AntDesign name={'sound'} color={'#fff'} size={scale(22)} />
          </TouchableOpacity>
...
export default PlacementDetailsScreen;
